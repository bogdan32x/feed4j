...
public class RawElement implements RawNode {
     ...
     */
    private ArrayList<RawAttribute> attributes = null;

    /**
     * The element nodes.
     */
    private ArrayList<RawNode> nodes = null;
     ...
     *             If the supplied index is not valid. It must be greater or equal to 0 and less than the value returned by
     *             getAttributeCount().
     */
     ...
     * @return The node.
     * @throws IndexOutOfBoundsException
     *             If the supplied index is not valid. It must be greater or equal to 0 and less than the value returned by getNodeCount().
     */
     ...
     * @return The first occurrence of a wanted sub-element, or null if it could not be found.
     */
     ...
     * @return The first occurrence of a wanted sub-element, or null if it could not be found.
     */
    public RawElement getElement(String name) {
        if (nodes == null) {
            return null;
        } else {
            for (RawNode node : nodes) {
     ...
     * @param name
     *            The name of the wanted element.
     * @return The value first occurrence of a wanted sub-element, or null if the element could not be found or if it exists but its value
     *         is not textual.
     */
    ...
    public String getElementValue(String name) {
        if (nodes == null) {
            ...
            RawElement element = getElement(name);
            if (element != null) {
                return element.getValue();
            } else {
                return null;
    ...
    public String toString() {
        ...
        builder.append("RawElement [namespaceURI=");
