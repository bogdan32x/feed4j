...
public class FeedItem extends RawElement {
    ...
    /**
     * The item GUID, used to identify it universally. It's very unusual that two non-equivalent items have the same GUID.
     */
     ...
     */
    private ArrayList<FeedEnclosure> enclosures = null;
    ...
    /**
     * This method returns the item GUID, used to identify it universally. It's very unusual that two non-equivalent items have the same
     * GUID.
     * 
     ...
     *             If the index supplied is not valid. It must be greater or equal to 0 and less than the value returned by
     *             getEnclosureCount().
     */
    public FeedEnclosure getEnclosure(int index) throws IndexOutOfBoundsException {
        if (enclosures == null) {
    ...
    /**
     * This method returns the item description as HTML code. It could be null if no description is supplied. If no HTML description is
     * supplied, but a plain text one is given, the HTML description is encoded automatically starting from the plain text one.
     * 
    ...
    /**
     * This method returns the item description as plain text. It could be null if no description is supplied. If no plain text description
     * is supplied, but a HTML encoded one is given, the plain text description is extracted automatically starting from the HTML one.
     * 
    ...
    public ArrayList<FeedEnclosure> getEnclosures() {
        return enclosures;
    }

    public void setEnclosures(ArrayList<FeedEnclosure> enclosures) {
