...
class TypeAtom_0_3 extends TypeAbstract {
    ...
    /**
     * This method parses a dom4j Document representation assuming it is an Atom 0.3 feed.
     * 
     * @param source
    ...
    public static Feed feed(URL source, Document document, int maxSize) {
        ...
        // The feed language.
        String language = header.getAttributeValue(Constants.XML_NAMESPACE, "lang");
    ...
    private static FeedItem handleEntry(URL source, RawElement entryElement) {
        ...
        String description = (content.length() > summary.length()) ? content : summary;
    ...
    /**
     * Gets an element value as plain text. The element must contain a "type" Atom attribute.
     */
