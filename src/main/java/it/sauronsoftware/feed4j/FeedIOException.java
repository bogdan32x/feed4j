...
/**
 * <<<<<<< HEAD This kind of exception is thrown by the parser every time a I/O error occurs during the reading of a feed. ======= This kind
 * of exception is thrown by the parser every time a I/O error occurs during the reading of a feed. >>>>>>> master
 * 
