...
class FeedRecognizer extends TypeAbstract {
    ...
    /**
     * It analyzes a XML document representation and return a costant suggesting the type of the feed in the document.
     * 
     * @param document
     *            The XML document representation.
     * @return UNKNOWN, RSS_1_0, RSS_2_0, ATOM_0_3 or ATOM_1_0, depending on the type recognized.
     */
    public static int recognizeFeed(Document document) {
        ...
        if ("rss".equals(name)) {
            ...
            String version = root.attributeValue("version");
            if (version == null || version.equals("1.0") || Constants.ATOM_NS_URI.equals(nsuri)) {
                return ATOM_1_0;
            } else if (version.equals("0.3") || Constants.ATOM_0_3_NS_URI.equals(nsuri)) {
                return ATOM_0_3;
            }
        }
        return UNKNOWN;
