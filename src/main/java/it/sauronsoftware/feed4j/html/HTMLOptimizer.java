...
/**
 * HTML code optimizer. It analyzes a HTML fragment fixing common mistakes and removing those attributes and tags usually useless for a feed
 * reader.
 * 
...
public class HTMLOptimizer {
    ...
    /**
     * The approved tags list, each element with its approved attributes. The residue will be removed.
     */
    private static final Tag[] TAGS = new Tag[] {
            ...
            new Tag("img", new Attribute[] { new Attribute("src", true), new Attribute("width", false), new Attribute("height", false), new Attribute("alt", false),
                    new Attribute("title", false) }), new Tag("a", new Attribute[] { new Attribute("href", true), new Attribute("title", false) }) };
